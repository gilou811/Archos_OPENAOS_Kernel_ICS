...
static int rotate180 = false;
module_param(rotate180, bool, S_IRUGO | S_IWUSR);
MODULE_PARM_DESC(rotate180, "Rotate180, default=no");

static int tsp_emulation = false;
module_param(tsp_emulation, bool, S_IRUGO | S_IWUSR);
MODULE_PARM_DESC(tsp_emulation, "Mono TSP Emulation, default=no");
